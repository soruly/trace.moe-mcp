/**
 * Extracts the MPEG-7 Color Layout Descriptor (CLD) from an RGB image buffer.
 *
 ...
 *
 * Returns an array of 33 coefficients: 21 for Y (luminance), 6 for Cb, and 6 for Cr.
 */

// Pre-calculated transformation matrix for 8x8 Type-II Discrete Cosine Transform (DCT)
// prettier-ignore
const COSINE_ARRAY = [
...
/**
 * Computes the 33-element MPEG-7 Color Layout Descriptor vector from a raw RGB buffer.
 *
 * @param data RGB byte buffer (3 bytes per pixel: R, G, B)
 * @param width Image width in pixels
 * @param height Image height in pixels
 * @returns 33-element integer vector
 */
export function getColorLayoutFeatureVector(
  ...
  const result = new Array<number>(33);
